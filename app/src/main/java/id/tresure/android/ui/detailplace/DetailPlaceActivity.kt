        ...
        @Suppress("DEPRECATION") if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            if (intent.getParcelableExtra(
                ...
                binding.apply {
                    ...
                    tvPrice.text =
                        intent.getParcelableExtra<ThemeParkResponseItem>(EXTRA_THEME_PARK)?.price?.currencyFormat()
                            ?: "Rp. 0"
                    tvCity.text =
                ...
                binding.apply {
                    ...
                    tvPrice.text =
                        intent.getParcelableExtra<ArtResponseItem>(EXTRA_ART)?.price?.currencyFormat()
                            ?: "Rp. 0"
                ...
                Glide.with(this).load(intent.getParcelableExtra<ArtResponseItem>(EXTRA_ART)?.image)
                    .into(binding.ivPlace)
            } else {
                null
            }
